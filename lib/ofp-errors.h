...
/* ## ------------------ ## */
    ...
    /* ONF1.1-1.3(4443), OF1.4+(14,3).  Can't handle this many properties. */
    OFPERR_OFPBPC_TOO_MANY,

    /* ONF1.1-1.3(4444), OF1.4+(14,4).  A property type was duplicated. */
    OFPERR_OFPBPC_DUP_TYPE,

    /* ONF1.1-1.3(4445), OF1.4+(14,5).  Unknown experimenter id specified. */
    OFPERR_OFPBPC_BAD_EXPERIMENTER,

    /* ONF1.1-1.3(4446), OF1.4+(14,6).  Unknown exp_type for experimenter id. */
    OFPERR_OFPBPC_BAD_EXP_TYPE,

    /* ONF1.1-1.3(4447), OF1.4+(14,7).  Unknown value for experimenter id. */
    OFPERR_OFPBPC_BAD_EXP_VALUE,

    /* ONF1.1-1.3(4448), OF1.4+(14,8).  Permissions error. */
    OFPERR_OFPBPC_EPERM,
